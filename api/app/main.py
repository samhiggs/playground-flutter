...
@api_v1.get("/items/", response_model=List[schemas.Item])
async def list_items(db: Session = Depends(get_db)):
    return crud.get_items(db=db)


@api_v1.post("/items/", response_model=schemas.Item)
...
@api_v1.put("/items/{item_id}", response_model=schemas.Item)
...
@api_v1.post("/items/{item_id}/purchase/", response_model=schemas.Item)
...
@api_v1.post("/items/{item_id}/unpurchase/", response_model=schemas.Item)
